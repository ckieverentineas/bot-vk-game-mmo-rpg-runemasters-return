...
Актуальная 1.0-линия: стартовая сборка должна иметь **два равноправных рунных слота**. Надетая руна работает полностью: статы, пассивы и активное действие не режутся ролью “поддержки”. Дополнительные слоты допустимы позже только как осознанный progression payoff через уровни, очки и ветку прокачки мастера, без FOMO, live-ops давления или pay-for-power ускорителей.
