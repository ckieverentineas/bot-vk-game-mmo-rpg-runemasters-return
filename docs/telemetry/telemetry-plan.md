...
| `economy_transaction_committed` | source/sink изменения зафиксированы | `transactionType`, `sourceType`, `resourceDustDelta`, `resourceShardsDelta`, `runeDelta`, `playerLevel`, `event_version` | economy health и outliers |
