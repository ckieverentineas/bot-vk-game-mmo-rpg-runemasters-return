...
- standalone exploration scenes получили player-facing типы (`передышка`, `находка`, `школьный след`, `опасный знак`, `Мастер испытаний`) и более широкий пул non-combat PvE-сцен без скрытых таймеров, FOMO или немедленных экономических мутаций;
