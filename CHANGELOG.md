...
- battle timeline в VK-сообщении теперь показывает до четырёх последних событий, чтобы действие игрока оставалось видимым после реакции врага, намерения и регена маны;
