...
- первый slice алхимии пилюль в Алтаре без новых таблиц: добыча тратится на четыре ранние пилюли для здоровья, атаки, защиты и рунного фокуса, результат даёт маленький постоянный рост базовой характеристики, а команды/кнопки используют pill-first fantasy вместо типичных зелий;
