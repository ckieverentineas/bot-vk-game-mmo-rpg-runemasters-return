...
- early school evidence теперь ловит и первый follow-up после novice payoff: открыл ли игрок руны, надел ли знак школы и начал ли следующий бой после признания школы;
