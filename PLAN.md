...
- Алтарь получил первый slice алхимии пилюль без новых таблиц: трофейные материалы превращаются в `Пилюлю живучести`, `Пилюлю острого удара`, `Пилюлю стойкости` и `Пилюлю рунного фокуса`, каждая даёт маленький постоянный рост базовой характеристики, стоимость масштабируется от уже поднятой характеристики, а клавиатура держится в лимите VK rows.
