...
- [~] Превратить собранную базу в сильный vertical slice, который реально хочется продолжать, а не просто «потыкать и уйти».
  ...
  - [x] Переделать rune hub в карусель по 5 рун с явным статусом `надета N / выбрана` и контекстными действиями `надеть / снять / распылить` только для выбранной руны.
