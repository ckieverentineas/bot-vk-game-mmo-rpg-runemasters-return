...
Текущий срез — это **первый playable rune combat slice**: в бою исполняются только уже поддержанные активные способности, passive-only руны пока продолжают работать как бонусы к статам, а мана понемногу возвращается при смене хода обратно к игроку.
