...
- post-battle trophy progression теперь поддерживает малые action-based срезы: базовый сбор добычи, threshold-действия для свежевания/реагентов/эссенции, второй мини-порог качества для свежевания/сбора слизи и enemy-kind действия для существующих трофейных врагов через тот же pending reward rail;
