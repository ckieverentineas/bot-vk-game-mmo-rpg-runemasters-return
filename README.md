...
- `src/vk/handlers/gameCommandRoutes.ts` и `src/vk/handlers/gameCommandRecovery.ts` — обычные маршруты команд и recoverable stale/retry контексты отдельно от `GameHandler`;
