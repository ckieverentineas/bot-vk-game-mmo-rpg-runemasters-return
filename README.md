...
- `src/vk/presenters/*` — player-facing тексты: общий barrel `messages.ts`, сценарные presenters для trophy/rune flow и общие чистые formatter'ы для повторяемых строк;
