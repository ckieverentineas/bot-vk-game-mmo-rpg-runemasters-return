...
- `src/vk/presenters/*` — player-facing тексты: общий barrel `messages.ts`, сценарные presenters для trophy/rune/battle flow и общие чистые formatter'ы для повторяемых строк;
