...
const createMainMenuLayout = (player?: PlayerState): KeyboardLayout => {
  ...
  return [
    ...
    [
      ...
      { label: '🏠 Трактир', command: gameCommands.runicTavern, color: Keyboard.PRIMARY_COLOR },
    ],
    [
    ...
    [
      ...
      { label: '🛠 Мастерская', command: gameCommands.workshop, color: Keyboard.PRIMARY_COLOR },
    ],
  ];
};
