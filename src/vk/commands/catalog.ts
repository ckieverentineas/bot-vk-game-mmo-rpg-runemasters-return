...
export const commandAliases: Readonly<Record<string, GameCommand>> = {
  ...
  'таверна': gameCommands.runicTavern,
  'доска угроз': gameCommands.runicTavern,
  'доска дозора': gameCommands.runicTavern,
  'рунный дозор': gameCommands.runicTavern,
  'дозор': gameCommands.runicTavern,
