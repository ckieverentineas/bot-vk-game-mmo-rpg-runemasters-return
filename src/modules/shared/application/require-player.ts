...
export const requirePlayerByVkId = async (repository: GameRepository, vkId: number): Promise<PlayerState> => {
...
export const requirePlayerById = async (repository: GameRepository, playerId: number): Promise<PlayerState> => {
