...
const buildNewRaritySummary = (rarity: RuneRarity): AcquisitionSummaryView => createSummary(
  ...
  `${rarityNameMap[rarity][0].toUpperCase()}${rarityNameMap[rarity].slice(1)} редкость приносит руне новый вес и заметнее меняет бой.`,
  'Откройте «🔮 Руны» и проверьте, как новая редкость ложится на ваш путь.',
);
  ...
  const changeLine = firstRune
    ...
    : activeAbility && school
      ...
      : school
        ...
        : newRarity
          ? `Это ваша первая ${rarityNameMap[newRarity]} руна: новый знак заметнее меняет бой.`
          : 'Руна даёт новый боевой инструмент и расширяет варианты пути.';

  const nextStepLine = firstRune
    ? 'Откройте «🔮 Руны», экипируйте её и зайдите в бой.'
    : 'Откройте «🔮 Руны» и примерьте её среди текущих рун.';
...
const buildMasteryUnlockSummary = (
  ...
  return createSummary(
    'mastery_unlock',
    `Новая веха школы: «${unlock.title}»`,
    `${schoolName} открывает новый приём пути: ${unlock.description}`,
    `Зайдите в следующий бой и почувствуйте новый знак школы ${schoolName}.`,
  );
};
...
const buildSlotUnlockSummary = (
  ...
  return createSummary(
    ...
    masteryUnlock && schoolName
      ? `${schoolName} вышла на новую веху «${masteryUnlock.title}»: теперь есть место для ещё одной полноценной руны.`
      : 'Путь стал шире: теперь можно надеть ещё одну полноценную руну.',
  ...
  switch (schoolCode) {
    case 'ember':
      return createSummary(
        ...
        'Пламя признало вашу решимость. Первая необычная руна делает давление школы вашим боевым знаком.',
    ...
    case 'stone':
      return createSummary(
        'school_trial_completed',
        'Испытание школы пройдено',
        'Твердь признала вашу стойкость. Первая необычная руна делает выдержку школы вашим боевым знаком.',
    ...
    case 'echo':
      return createSummary(
        'school_trial_completed',
        'Испытание школы пройдено',
        'Прорицание признало ваше чтение угрозы. Первая необычная руна делает точный ответ знаком школы.',
        'Откройте «🔮 Руны», наденьте первый знак школы и проверьте его на следующей явной угрозе.',
      );
    case 'gale':
      return createSummary(
        'school_trial_completed',
    ...
    default:
      return createSummary(
        'school_trial_completed',
        'Испытание школы пройдено',
        `${schoolName} признала ваш первый шаг. Теперь путь школы ${schoolNameGenitive} закреплён первой необычной руной.`,
        'Откройте «🔮 Руны» и закрепите новый знак школы.',
      );
  }
};
  ...
  switch (schoolCode) {
    ...
    case 'echo':
      return createSummary(
        'school_miniboss_completed',
        'Большой бой школы пройден',
        'Прорицание признало, что вы увидели угрозу и ответили точно. Редкая руна стала печатью вашего чтения боя.',
        'Откройте «🔮 Руны», наденьте новую печать школы и проверьте её на следующей явной угрозе.',
      );
    default:
      return createSummary(
        'school_miniboss_completed',
        ...
        'Откройте «🔮 Руны» и закрепите новую печать школы.',
      );
  }
};
  ...
  switch (schoolCode) {
    case 'ember':
      return createSummary(
        ...
        'Первый знак Пламени теперь в основе: школа отвечает вашим ударом, а не ждёт в сумке.',
    ...
    case 'stone':
      return createSummary(
        ...
        'Первый знак Тверди теперь в основе: школа держит выдержку и ответный ход.',
    ...
    case 'gale':
      return createSummary(
        ...
        'Первый знак Бури теперь в основе: школа держит темп и готовит следующий ответ.',
    ...
    case 'echo':
      return createSummary(
        ...
        'Первый знак Прорицания теперь в основе: школа играет через чтение угрозы и точный ответ.',
    ...
    default:
      return createSummary(
        ...
        `Первый знак школы ${schoolNameGenitive} теперь в основе: путь школы отвечает в бою, а не ждёт в сумке.`,
  ...
  switch (schoolCode) {
    case 'ember':
      return createSummary(
        ...
        'Редкая печать теперь в руках: Пламя крепче давит базовой атакой и открывает цель печати.',
    ...
    case 'stone':
      return createSummary(
        ...
        'Редкая печать теперь в руках: Твердь крепче держит защитную стойку и «Каменный отпор».',
    ...
    case 'gale':
      return createSummary(
        ...
        'Редкая печать теперь в руках: Буря крепче прикрывает «Шаг шквала» и открывает цель печати.',
    ...
    case 'echo':
      return createSummary(
        ...
        'Редкая печать теперь в руках: Прорицание точнее отвечает по раскрытой угрозе.',
    ...
    default:
      return createSummary(
        ...
        `Редкая печать школы ${schoolNameGenitive} теперь в руках и даёт малую силу этой школы.`,
        'Следующий шаг: ищите «Цель печати» и доведите школу до нового ранга.',
      );
  }
};
