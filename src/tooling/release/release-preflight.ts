...
console.log(
  [
    ...
    '5. npm run release:status',
    '6. npm run release:summary',
    '7. npm run release:evidence',
    '8. Синхронизировать README.md, CHANGELOG.md, PLAN.md, RELEASE_CHECKLIST.md и ARCHITECTURE.md, если менялось пользовательское поведение или архитектурные границы.',
  ].join('\n'),
);
